...
contract WorldTest is Test, GasReporter {
  ...
  function testRegisterTable() public {
    ...
    world.registerTable(tableSelector, defaultKeySchema, valueSchema, keyNames, valueNames);
    endGasReport();
    ...
    world.registerTable(otherTableSelector, defaultKeySchema, valueSchema, keyNames, valueNames);
